...
electronic_shopping.plot()
plt.title('Electronic Shopping Retail Sales')
plt.tight_layout()
plt.savefig('electronic_shopping.png')
plt.show()
...
plt.tight_layout()
#plt.savefig('elec_shopping_acf.png')
plt.show()
...
plt.tight_layout()
#plt.savefig('elec_shopping_decomp.png')
plt.show()
...
plt.title('Electronic Shopping ACF and PACF')
plt.tight_layout()
#plt.savefig('elec_shopping_acf_pacf.png')
plt.show()
...
plt.title('Electronic Shopping Seasonal ACF and PACF')
plt.tight_layout()
#plt.savefig('elec_shopping_acf_pacf_seasonal.png')
plt.show()
...
plt.tight_layout()
#plt.savefig('elec_shopping_diag.png')
plt.show()
...
plt.tight_layout()
plt.savefig('elec_shopping_log_prediction.png')
plt.show()
...
plt.tight_layout()
#plt.savefig('elec_shopping_prediction.png')
plt.show()
